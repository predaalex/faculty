...
public class Fereastra extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        okButton.setText("Compute the sum");
        ...
        jLabel1.setText("Write a sum of two terms(e.g., 2+3):");

        jLabel2.setText("Replies from SWI:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
        	conexiune.expeditor.trimiteMesajSicstus("hello");
        } catch (Exception ex) {
            Logger.getLogger(Fereastra.class.getName()).log(Level.SEVERE, null, ex);
        }
