...
public class DiagnosisWindow extends JFrame {
    ...
    private void initComponents() {
        resourcesDir = new File("resources/lab5");
    ...
    private void setupLayout() {
        ...
        JLabel exerciseNameLabel1 = new JLabel("Exercise 1");
    ...
    private void runDiagnosis() {
        ...
        try {
            ...
            if (res.equals("entailed")) resultField.setText("ENTAILED");
            else resultField.setText("NOT ENTAILED");
        } catch (Exception ex) {
            ex.printStackTrace();
            resultField.setText("Error: " + ex.getMessage());
        }
